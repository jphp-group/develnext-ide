...
class PhpAnyAutoCompleteType extends AutoCompleteType
{
    ...
    public function getStatements(AutoComplete $context, AutoCompleteRegion $region)
    {
        if (in_array($this->kind, ['~any'])) {
            $result = [
                new StatementAutoCompleteItem('if', 'Условие (если)', 'if ($1) $0'),
                new StatementAutoCompleteItem('else', 'Иначе ...', 'else '),
                new StatementAutoCompleteItem('elseif', 'Иначе если ...', 'elseif ($1) $0'),
                ...
                new StatementAutoCompleteItem('unset', '', 'unset($1)$0'),
                new StatementAutoCompleteItem('isset', '', 'isset($1)$0'),
                new StatementAutoCompleteItem('empty', '', 'empty($1)$0'),
